    ...
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-8 lg:w-1/2">
        ...
        <p className="text-dark-light mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:text-left">
          Read the most interesting articles on pests. Write, comment or share
        ...
        <div className="flex flex-col gap-y-2.5 mt-10 lg:mt-6 xl:mt-10 relative">
          ...
          {/* <button className="w-full bg-primary text-white font-semibold rounded-lg px-5 py-1 md:py-2 md:absolute md:right-2 md:top-1/2 md:-translate-y-1/2 md:w-fit md:py-2">
            Search
          </button> */}
        </div>
